...
def render_page_content(pathname):
    if pathname == "/":
        ...
        app.layout = dbc.Container([
            ...
            dbc.Tabs(
                [
                    dbc.Tab(label="Analista 1", tab_id="tab1"),
                    dbc.Tab(label="Analista 2", tab_id="tab2"),
                    dbc.Tab(label="Analista 3", tab_id="tab3"),
                    dbc.Tab(label="Analista 4", tab_id="tab4"),
...
def render_tab_content(active_tab, data):
    ...
    [
        ...
        dbc.Alert("Actividad 3: vencida y avance al 0% ", color="danger",
            dismissable=True),
        dbc.Alert("Actividad 2: queda 1 día para su vencimiento.", color="warning",
            dismissable=True),
